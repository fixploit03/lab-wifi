...
ap_ns="ap-opn"
sta_ns="sta-opn"
ip_addr="10.10.1.1/24"
hostapd_conf="${base_dir}/conf/opn/hostapd.conf"
dnsmasq_conf="${base_dir}/conf/opn/dnsmasq.conf"
wpa_supplicant_conf="${base_dir}/conf/opn/wpa_supplicant.conf"
txpower=500
...
gen_traffic "${ap_ns}" "${sta_ns}" "10.10.1.1"
